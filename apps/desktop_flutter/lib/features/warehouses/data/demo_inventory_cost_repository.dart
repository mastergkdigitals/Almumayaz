...
enum _InventoryCostEventKind { purchase, transfer, sale }
...
int _toIqdMinorUnits(Money value, ExchangeRate rate) {
  ...
  return divideAndRoundHalfAwayFromZero(
    value.minorUnits * rate.tenThousandths,
...
int _fromIqdMinorUnits(
  ...
  return divideAndRoundHalfAwayFromZero(
    value * AppCurrency.usd.scale * 10000,
    rate.tenThousandths,
  );
}
...
List<InventoryCostBalance> demoInventoryCostOpeningBalances() => [
      ...
      _openingCost('warehouse-001', 'item-006', 5, 20000),
